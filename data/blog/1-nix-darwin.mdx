---
title: Nix-Darwin으로 맥북 개발환경 자동화하기
date: '2025-04-05'
tags: ['tool']
draft: false
summary: 선언적 패키지 관리자 Nix-Darwin을 활용해 맥북 초기 설정부터 개발 툴 설치까지 한 번에 자동화하는 방법
---
...
> 최신 설정을 참조할려면 https://github.com/Yanguk/dotfiles/tree/dev/nix
